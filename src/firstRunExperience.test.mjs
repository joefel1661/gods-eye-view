...
test('the voice TOOL SCHEMA matches the pinned release — the mission mapping is instructions only', () => {
  // ALPR and Security Points deliberately add their IDs to the voice-visible layer menus and aliases.
  ...
  assert.equal(block.length, 26043, 'serialized tool schema length drifted');
  assert.equal(
    crypto.createHash('sha256').update(block).digest('hex'),
    'cdd00fb3ebc456bfda45c2c873de64bdeb27bd913dc29e00c1e46985ba807bbd',
